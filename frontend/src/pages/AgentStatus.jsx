...
export default function AgentStatus() {
  ...
  const agents = results ? [
    { label: "Gemini LLM",              key: "gemini_llm",              desc: "Core AI model powering all agents" },
    { label: "Gemini Embeddings",        key: "gemini_embeddings",       desc: "Vector embeddings for RAG" },
    { label: "Resume Analyzer Agent",    key: "resume_analyzer_agent",   desc: "PDF parsing + skill extraction" },
    { label: "Job Scraper Agent",        key: "job_scraper_jsearch",     desc: "Live job search via JSearch API" },
    { label: "Resume Rewriter Agent",    key: "resume_rewriter_agent",   desc: "AI resume optimization" },
    { label: "Mock Interview Agent",     key: "mock_interview_agent",    desc: "Question generation" },
    { label: "Answer Scoring Agent",     key: "answer_scoring_agent",    desc: "Interview answer evaluation" },
    { label: "Daily Coach Agent",        key: "daily_coach_agent",       desc: "English conversation partner" },
